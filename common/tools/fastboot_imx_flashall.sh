...
options:
  ...
  -d dtb_feature    flash dtbo, vbmeta and recovery image file with "dtb_feature" in their names
                        ...
                        Below table lists the legal value supported now based on the soc_name provided:
                           ...
                           │                │  15x15 15x15-mipi-panel 15x15-aud-hat 15x15-mqs rpmsg                                                │
                           ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
...
imx93_dtb_feature=()
imx95_dtb_feature=(mipi-lvds1 mipi-panel lvds0 lvds-dualdisp lvds-panel cs42888 verdin verdin-adv7535 verdin-lvds-panel 15x15 15x15-mipi-panel 15x15-aud-hat 15x15-mqs rpmsg)
